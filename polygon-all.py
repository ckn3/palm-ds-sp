...
def main():
    ...
    model_path = input("Enter the path to the YOLO model (.pt file) [default: best.pt]: ") or "weights/best.pt"
    model = load_yolo_model(model_path)
    sam_model_path = input("Enter the path to the SAM model (.pt file) [default: mobile_sam.pt]: ") or "weights/mobile_sam.pt"
